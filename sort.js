...
function CreateVisualDatabase(database) {
  for (let i = 0; i < database.length; i++) {
    ...
    //agregar valores al option 
    var optiones1 = document.createElement("option");
    var optiones2 = document.createElement("option");

    selector1.appendChild(optiones1);
    selector2.appendChild(optiones2);
  }
}
